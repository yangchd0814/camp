...
import com.yangchd.week09.homework03.core.api.RpcRequest;
import com.yangchd.week09.homework03.core.api.RpcResponse;
import com.yangchd.week09.homework03.core.netty.common.RpcProtocol;
...
public class RpcNettyClientSync {
    ...
    private EventLoopGroup clientGroup = new NioEventLoopGroup(10, new ThreadFactoryBuilder().setNameFormat("client work-%d").build());
